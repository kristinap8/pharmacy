    ...
    export default {
        ...
        data() {
            return {
                search:"",
                price:0,
                sortByPriceDir:["за зростанням","за спаданням"],
                chosenDir:sortByPriceDir[0],
           ...
           return this.getMedicines
            ...
            methods: {
                sortByPrice:function() {
                     if(this.chosenDir==this.sortByPriceDir[0])
                     { 
                        this.chosenDir=this.sortByPriceDir[1]
                     }else{
                        this.chosenDir=this.sortByPriceDir[0]
                     }
